...
import 'schema/match_history_record.dart';
...
export 'schema/match_history_record.dart';
...
/// Functions to query MatchHistoryRecords (as a Stream and as a Future).
Future<int> queryMatchHistoryRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MatchHistoryRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MatchHistoryRecord>> queryMatchHistoryRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      MatchHistoryRecord.collection(parent),
      MatchHistoryRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MatchHistoryRecord>> queryMatchHistoryRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<int> queryFriendRequestsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      FriendRequestsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
