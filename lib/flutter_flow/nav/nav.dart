...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CreateGameMapWidget.routeName,
          path: CreateGameMapWidget.routePath,
          builder: (context, params) => CreateGameMapWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: InGamePageWidget.routeName,
          path: InGamePageWidget.routePath,
          builder: (context, params) => InGamePageWidget(
        ...
        FFRoute(
          name: FriendProfileWidget.routeName,
          path: FriendProfileWidget.routePath,
          asyncParams: {
            'uid': getDoc(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => FriendProfileWidget(
            uid: params.getParam(
              'uid',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: UpdateGameSettingsWidget.routeName,
          path: UpdateGameSettingsWidget.routePath,
          asyncParams: {
            'game': getDoc(['games'], GamesRecord.fromSnapshot),
          },
          builder: (context, params) => UpdateGameSettingsWidget(
